                ...
                <ul className="list-[disclosure-closed] pl-5">
                    <li>
                        <div>
                            ...
                            <ul >
                                <li >Bạn có thể {highlightText('')} tìm hiểunhững thông tin khái quát về phần mềm, bản đồ tỉnh trà vinh và những đối tượng cụ thể trong từng huyện, thị, thành phố</li>
                    ...
                    <li>
                        <div>
                        Để có trải nghiệm tốt hơn, bạn có thể tạo tài khoản và đăng nhập vào phần mềm ở mục{' '} <b>Đăng ký/ đăng nhập</b> để có thể viết bình luận, bổ sung thông tin, chơi trò chơi, thích bài viết,...
                        </div>
                    </li>
                    <li>
                        <div>
